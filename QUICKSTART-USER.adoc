...
// Replace rrecord-verity, Rrecord Verity — See README.adoc for details., just run, Rrecord Verity started successfully. with actuals
= rrecord-verity — Quick Start for Users
:toc:
:toclevels: 2

== What is rrecord-verity?

Rrecord Verity — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./rrecord-verity-portable
----
...
[source]
----
Rrecord Verity started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/rrecord-verity/wiki
