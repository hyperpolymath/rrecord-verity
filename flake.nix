{
  description = "rrecord-verity - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P rrecord-verity.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/rrecord-verity $out/bin/  # Rust
            # cp bin/rrecord-verity $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/rrecord-verity";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-rrecord-verity" {
