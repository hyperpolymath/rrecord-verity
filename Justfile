...
doctor:
    @echo "Running diagnostics for rrecord-verity..."
...
heal:
    @echo "Attempting auto-repair for rrecord-verity..."
...
help-me:
    @echo "=== rrecord-verity Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/rrecord-verity/issues/new"
    @echo ""
